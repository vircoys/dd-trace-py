"""
This integration instruments graphql-core queries. Version 2.0 and above are fully
supported.
...
.. py:data:: ddtrace.config.graphql["service"]
   ...
   To enable ``graphql.resolve`` spans set ``DD_TRACE_GRAPHQL_PATCH_RESOLVERS`` to True
